...
let pizzaName: string[] = ["Tikka", "fajita", "pepprecon"];

for (let pizza of pizzaName){
    console.log (`i like ${pizza} Pizza.`)
}
console.log (`I really love ${pizzaName[0]} pizza!\n I really like ${pizzaName[1]} Pizza \n ${pizzaName[3]} Pizza is my Favourit`)